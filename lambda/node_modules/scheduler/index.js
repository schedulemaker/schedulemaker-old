...
function hasSameDay(s1, s2){
    days1 = s1.classTimes.map(c => c.day);
    days2 = s2.classTimes.map(c => c.day);
...
class Scheduler{
     ...
     * Only time conflicts are checked. The algorithm "reaches forward" as far as it can go,
     ...
     * The algorithm continues this process of reaching and backtracking until all possibilities have been exhausted.
     *
     * @param {[Course]} courses - An array of Courses that the user has provided. This includes any "special courses" (job, 
     * sports/music practice, etc) that the user may have provided.
     *
